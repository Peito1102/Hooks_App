...
import { getInitialScrumbleState, scrambleWordsReducer } from './reducer/scrambleWordsReducer';
import { GAME_WORDS } from './interfaces/ScrumbleState';

export const ScrambleWords = () => {
  
  const [guess, setGuess] = useState('');

  const [state, dispatch] = useReducer(scrambleWordsReducer, getInitialScrumbleState());
